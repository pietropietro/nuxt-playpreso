<template>
    <div>
        ...
        <v-row :style="'background-color: ' + ppRGBA(participation.ppLeagueType,'.5')" justify="center" v-if="!participation.ppLeague.started_at">
            <h2>NOT STARTED</h2>
        </v-row>
        <template v-else>
            <v-row class="px-2" align="center" :style="'background-color: ' + ppRGBA(participation.ppLeagueType,'.5')">
                <v-col cols="4">
